import {
  ...
  export function ListarMaterialPelotao(props) {
    const dep = props.dependencia as string;
        ...
        >
          <TableContainer w="100%">
            <Table size="xs" colorScheme="whiteAlpha">
              <Thead>
                <Tr>
                  <Th p={2} textAlign="center">Material</Th>
                  <Th p={2} textAlign="center">Quantidade</Th>
                  <Th p={2} textAlign="center">Informações</Th>
                </Tr>
              </Thead>
              <Tbody>
                {materiais
                  ?.filter((mat) => mat.sub_unidade === cia && mat.dependencia === dep).sort((x, y) => {
